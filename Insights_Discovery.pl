...
hypothesis(inventor) :- inventor, !. %INTJ
hypothesis(challenger) :- challenger, !. %ESTP
hypothesis(warrior) :- warrior, !. %ESTJ
hypothesis(rebel) :- rebel, !. %ENTJ
hypothesis(entrepreneur) :- entrepreneur, !. %ENTP
hypothesis(pioneer) :- pioneer, !. %ENFP
hypothesis(entertainer) :- entertainer, !. %ENFJ
hypothesis(reveler) :- reveler, !. %ESFJ
hypothesis(king) :- king, !. %ESFP
hypothesis(healer) :- healer, !. %INFJ
hypothesis(lover) :- lover, !. %INFP
hypothesis(companion) :- companion, !. %ISFP
hypothesis(physician) :- physician, !. %ISFJ
hypothesis(diplomat) :- diplomat, !. %ISTJ
hypothesis(judge) :- judge, !. %ISTP
hypothesis(wizard) :- wizard, !. %INTP
